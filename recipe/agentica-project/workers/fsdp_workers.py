...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self):
        ...
        if rollout_name == 'hf':
            from ..workers.rollout import HFRollout
            ...
            from ..workers.rollout.vllm_rollout import vLLMRollout, vllm_mode
            from ..workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
            ...
            from ..workers.rollout.sglang_rollout import SGLangRollout
            ...
            from ..workers.sharding_manager.fsdp_sglang import FSDPSGLangShardingManager
            log_gpu_memory_usage(f'Before building {rollout_name} rollout', logger=None)
    ...
    def init_model(self):
        from ..workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from ..utils.model import LambdaLayer, print_model_size, squeeze
    ...
    def init_model(self):
        ...
        from ..workers.critic import DataParallelPPOCritic
...
class RewardModelWorker(Worker):
    ...
    def _build_model(self, config):
        ...
        if use_remove_padding:
            from ..models.registry import check_model_support_rmpad
    ...
    def _forward_micro_batch(self, micro_batch):
        from ..models.bert_padding import pad_input, unpad_input, index_first_axis, rearrange
    ...
    def compute_rm_score(self, data: DataProto):
        import itertools
        from ..utils.seqlen_balancing import rearrange_micro_batches, get_reverse_idx
        # Support all hardwares
        data = data.to(torch.cuda.current_device())
