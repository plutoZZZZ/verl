...
if [ -z "$MODEL_PATH" ]; then
    MODEL_PATH="/file_system/common-models/DeepSeek/DeepSeek-R1-Distill-Qwen-1.5B"
fi
...
python3 -m recipe.agentica-project.trainer.main_ppo_async \
    algorithm.adv_estimator=grpo \
    data.train_files=/file_system/lusz/dataset/gsm8k/train.parquet \
    data.val_files=/file_system/lusz/dataset/gsm8k/test.parquet \
    ...
    trainer.experiment_name='deepscaler-math-async' \
